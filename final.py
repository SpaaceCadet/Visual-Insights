...
#overview_time_series = create_figure_about()
                                    ...
                                    children=[
                                        ...
                                        html.Li(
                                            children=[
                                                ...
                                                dcc.Link(children=[html.Label('Vanilla LSTM')],href="/vanilla",className='no-underline')
                                            ]
                                        ),
                                        html.Li(
                                            children=[
                            ...
                            children=[
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        html.U(html.H1('Hourly Energy forecast using Deep learning models')), html.Br(),
                                ...
                                html.Ul(
                                    ...
                                    children=[
                                        html.Li(
                                            ...
                                            children=[
                                                html.I(className='fas fa-home'),
                                                dcc.Link(children=[html.Label('About the Dataset')],href="/", className='no-underline')
                                            ]
                                        ),
                                        html.Li(
                                            className='selected',
